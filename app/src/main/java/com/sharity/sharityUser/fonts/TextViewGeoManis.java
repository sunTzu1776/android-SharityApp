...
public class TextViewGeoManis extends TextView {
    private static final String TAG = "TextView";

    public TextViewGeoManis(Context context) {
        super(context);
    }

    public TextViewGeoManis(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public TextViewGeoManis(Context context, AttributeSet attrs, int defStyle) {
